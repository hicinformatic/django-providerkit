...
django-providerkit/
├── src/
│   └── djproviderkit/        # Main package directory
...
The public API is defined in `src/djproviderkit/__init__.py`:
- `fields_associations`: Mapping of field types to Django model fields
- Models: Import from `djproviderkit.models`
- Admin: Import from `djproviderkit.admin`
